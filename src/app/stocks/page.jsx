        ...
        <>
            <div className="w-full flex min-h-screen justify-center relative">
                <div className="w-3/4">
                    ...
                    <div className="pt-4">
                        <button onClick={() => router.push(`/stocks/actions`)} className="py-2 px-3 bg-amber-900 rounded font-semibold hover:scale-105 duration-300 hover:cursor-pointer">Add Stocks</button>
                    </div>
                                ...
                                {stock.map((row) => {
                                    return (
                                        <div key={row.id} className="bg-amber-400 text-black text-right p-2 rounded flex flex-col">
                                            ...
                                            <span className={`${row.restock ? "text-red-700" : "text-green-700"}`}>{row.restock ? "restock" : "safe"}</span>
